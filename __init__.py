...
from tensorflow.keras.layers import create_vgg16_layers, create_extra_layers, create_conf_head_layers, create_loc_head_layers
...
def main(num_classes, arch, pretrained_type,
               checkpoint_dir=None,
    ...
    class ssdModel:
        ...
        def predict(self, inputdata):
            output = self.model.call(inputdata)
            return output
    return ssdModel()
